/**
 * HW4: Implement custom BigInt Java class
 * BigInt.java
 */
...
public class BigInt implements Comparable<BigInt> {
   ...
   //eg "12341293487192857623948756293487562938457236046981406"
    ...
    // USE STACK TO PUSH RESULT - recursive "smart" answer not practical for large BigInt
    public BigInt multiply(BigInt n) {
        ...
        /* Recursive solution (deprecated): compiles and runs but gives incorrect answer
    ...
    public BigInt multiply(int n) throws IllegalArgumentException {
        /* Multiply BigInt by single-digit integer from 0-9,
           ...
           If n is 10 or higher, can convert to BigInt */
        if (n < 0 || n >= 10) {
        ...
        if (result < 10) {
            ...
            if (i != 0) {
                ...
                resultingBigInt.data.add(result);
                    ...
                    // Method may leave double-digit integer values in head node
